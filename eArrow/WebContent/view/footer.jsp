	...
	<body>
		...
		<div class="footer">
			...
			<div class="footer-content">
				...
				<div id="contacts">
				<label for="exampleFormControlInput1"><dt>Info su eArrow</dt></label>
					<ul>
	                   <li>ciao</li>
	                   <li>ciao</li>
	                   <li>ciao</li>
				...
				<div id="contact-us">
					...
					<form>
					  ...
					  <div class="form-group">
					    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Scrivi il tuo messaggio"></textarea>
					  </div>
					</form>
			...
			<div class="footer-celebration">
				...
				<p id ="logo"><img src = '..//image/eArrow.png' width="50" height="50"></p>
			</div>
